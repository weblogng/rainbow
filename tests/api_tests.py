...
class DeployTestCase(unittest.TestCase):
    ...
    def test_deploy_puts_the_specified_artifact_to_the_remote_server_and_extracts_it(self, cd, run, put, directory):
        ...
        run.assert_called_with("tar -xvf {artifact_name} -C {dest_dir}".format(**locals()))
